...
In order to produce reasonable and readable plotly graphs, I randomly sampled 5000 restaurants of rank A situated solely in Manhattan as a subset from the entire dataset and made a scatterplot, a boxplot, and a bargraph to conductexploratory analysis of the data visually.